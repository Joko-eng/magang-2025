        ...
        <div className="mt-16 flex justify-center">
          <fieldset aria-label="Payment frequency">
            <RadioGroup
              ...
              className="grid grid-cols-5 gap-x-1 rounded-full p-1 text-center text-[9px] font-semibold leading-5 ring-1 ring-inset ring-gray-200 lg:text-xs"
            >
        ...
        <div className="mt-16 flex justify-center">
          <fieldset aria-label="Payment frequency">
            <RadioGroup
              ...
              className="grid grid-cols-2 gap-x-1 rounded-full p-1 text-center text-[9px] font-semibold leading-5 ring-1 ring-inset ring-gray-200 lg:text-xs"
            >
