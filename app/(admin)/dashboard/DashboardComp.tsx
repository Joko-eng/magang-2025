      ...
      <div className="py-6 px-14">
        <div className="flex flex-col justify-center items-center min-h-64 space-y-4">
          <div className="text-lg text-red-500 text-center max-w-2xl">
            ...
            <pre className="text-sm bg-red-50 p-4 rounded border text-left overflow-auto">{error}</pre>
          </div>
          <div className="space-x-4">
            <Button onClick={() => fetchPosts()} className="bg-blue-500 hover:bg-blue-600 text-white">
              Coba Lagi
            </Button>
            <Button onClick={() => window.open('/api/instagram', '_blank')} variant="outline">
              Test API
            </Button>
          </div>
        </div>
    ...
    <>
      <div className="py-6 px-14">
        <div className="flex justify-end items-center mb-6 sm:items-end">
          ...
          <CreatePostDialog open={isDialogOpen} onOpenChange={setIsDialogOpen} onSuccess={fetchPosts} />
            ...
            <Card key={post._id} className="p-4 mb-4 dark:bg-primary">
              <div className="flex flex-col md:grid md:grid-cols-4 md:items-center gap-4">
                ...
                <div className="md:col-span-2 gap-2 p-2 rounded-md flex flex-col justify-center">
                  <h2 className="font-semibold text-base text-center md:text-left dark:text-white">{post.title}</h2>
