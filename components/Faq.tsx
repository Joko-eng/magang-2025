        ...
        <section className="py-10 md:py-24">
            <div className="mx-auto max-w-5xl px-4 md:px-6 dark:text-white">
                <div className="mx-auto max-w-xl text-center">
                    <h2 className="text-balance text-2xl font-bold md:text-2xl lg:text-2xl">Pertanyaan yang sering diajukan</h2>
                    <p className="text-muted-foreground mt-4 text-balance dark:text-white">Jika Pertanyaan anda tidak terjawab, jangan ragu untuk menghubungi tim dukungan kami.</p>
                </div>
